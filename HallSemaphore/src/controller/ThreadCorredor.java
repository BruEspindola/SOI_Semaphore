...
public class ThreadCorredor extends Thread {
	...
	private void pessoaAndando() {
		...
		while (distanciaPercorrida < distanciaCorredor) {
			...
			System.out.println("A pessoa #" + ((getId()) - 10) + " já andou " + distanciaPercorrida + "m.");
		}
	...
	private void sair() {
		abrirPorta++;
		System.out.println("A pessoa #" + ((getId() - 10)) + " foi o " + abrirPorta + "º a abrir a porta e a cruza-la");
	}
